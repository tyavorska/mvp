        ...
        <div class="post_right_side">
            ...
            while (have_posts()) :
                ...
                <div class="post_social">
                    <div class="post_social_left"></div>
                    <div class="post_social_right">
                        <div class="post_social_subscribe"></div>
                        <div class="post_social_mail"></div>
                        <div class="post_social_button">
                            <div class="post_social_drop">
                                <?php echo do_shortcode('[Sassy_Social_Share style="background-color:transparent;"]') ?>
                            </div>
                        </div>
